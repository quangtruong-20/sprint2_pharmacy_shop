...
import ModalDeleteCartDetail from "../until/ModalDeleteCartDetail";
...
export default function Pay() {
    ...
    const handlePayment = async () => {
        ...
        if (!role) {
            ...
            try {
            const res = await paymentService.pay(total)
    ...
    return (
        <>
            ...
            <div className="Cart_cart-page__kClbp">
            <div className="container">
                <nav>
                    <ol
                        className="Breadcrumbs_breadcrumbs__04vpL"
                        itemScope=""
                        itemType="http://schema.org/BreadcrumbList"
                    >
                        <li
                            className="Breadcrumbs_item__e9mbT"
                        ...
                        <li
                            className="Breadcrumbs_item__e9mbT Breadcrumbs_item-active__3fOia"
                            itemProp="itemListElement"
                            itemScope=""
                            itemType="http://schema.org/ListItem"
                        >
                ...
                <div className="Cart_empty-cart__kp5dY">
                    <div className="EmptyCart_empty-cart__nVgTZ">
                        <img src="https://www.pharmacity.vn/images/empty-image.png" alt="empty-cart"/>
                        <p>
                            Tiếc quá! Trường An không tìm thấy sản phẩm <br/> nào trong giỏ hàng của
                            bạn.
                        </p>
                    </div>
                        <NavLink to={'/'}>
                    <button className="Button_pc-button__GX6DG Button_warning__N__4t">
                        Tiếp tục mua hàng
                    </button>
                        </NavLink>
                </div>
            ...
            <span className="CartList_title__2MGsm">
              <svg width={10} height={16} stroke="#112950" viewBox="0 0 10 16" fill="none" style={{ marginRight: "1rem" }}>
                <path d="M8.5 15L1.5 8L8.5 1" stroke="inherit" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              Giỏ hàng
            </span>
                                ...
                                <div className="CartList_content__uSLn0">
                                    <table>
                                        ...
                                        <tr name="UHJvZHVjdFZhcmlhbnQ6MjUxMDg=" className="CartItem_cart-item__oeS59" key={index}>
                                            <td className="CartItem_product-col__5yb6n">
                                                <a href="/pmc-khau-trang-soft-fit-goi-5-cai-pink.html">
                                                    <figure>
                                                        <img
                                                            src={
                                                                cartDetail.productDTO.productImgDTO[0]
                                                                    .url
                                                            }
                                              ...
                                              <p className="CartItem_oldPadding__OfPNE">
                                                    ...
                                                    <p className="CartItem_price-current__qT_vp">
                                                     {" "}
                                                        {cartDetail.productDTO.price.toLocaleString("vi-VN", {
                                                            style: "currency",
                                                            currency: "VND",
                                                        })}
                                                        {/*<span>Gói</span>*/}
                                            ...
                                            <td className="CartItem_action__BM8qk">
                                                <button data-bs-toggle="modal"
                                                    ...
                                                    <svg width={24} height={24} viewBox="0 0 24 24" fill="none">
                                                        <path d="M19.3238 9.4668C19.3238 9.4668 18.7808 16.2018 18.4658 19.0388C18.3158 20.3938 17.4788 21.1878 16.1078 21.2128C13.4988 21.2598 10.8868 21.2628 8.27881 21.2078C6.95981 21.1808 6.13681 20.3768 5.98981 19.0458C5.67281 16.1838 5.13281 9.4668 5.13281 9.4668" stroke="#5E6F88" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                        <path d="M20.708 6.23828H3.75" stroke="#5E6F88" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                        <path d="M17.4406 6.239C16.6556 6.239 15.9796 5.684 15.8256 4.915L15.5826 3.699C15.4326 3.138 14.9246 2.75 14.3456 2.75H10.1126C9.53358 2.75 9.02558 3.138 8.87558 3.699L8.63258 4.915C8.47858 5.684 7.80258 6.239 7.01758 6.239" stroke="#5E6F88" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                    </svg>
                                                </button>
                                            </td>
                                        </tr>
                        ...
                        <div className="TotalCart_total-cart-container__zIAY9">
                            <div className="TotalCart_total-cart__mIMtg">
                                ...
                                <div className="TotalCart_footer__ysUJW d-flex justify-content-between">
                                    ...
                                    <button className="TotalCart_btn-start-checkout___8Dt7"  onClick={() => handlePayment()}>
                                        <p>
                                            <b>Thanh toán</b>
                                            <svg width="16px" height="16px" viewBox="0 0 24 24" fill="none" stroke="white">
