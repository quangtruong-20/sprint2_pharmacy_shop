    ...
    public void sendEmail(PaymentSendEmailDTO paymentSendEmailDTO) {
        ...
        try {
            ...
            message.setText( "<html>" +
                    ...
                    "Hy vọng quý khách hàng có trải nghiệm tốt khi sử dụng sản phẩm của Nhà thuốc Trường An, "
                    +"<br>"
                    + "<br>" +
                    ...
                    + "<br>"
                    + "Trân trọng," +
                    "<div style =\"color:#12ac4c; font-size:20px ; font-weight:bold\">Nhà thuốc Trường An</div>" +
                    "</div>" +
                    "</body>" +
                    "</html>", true);
